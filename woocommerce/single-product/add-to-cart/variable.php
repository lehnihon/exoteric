	...
	<?php if ( ! empty( $available_variations ) ) : ?>
		<table class="variations" cellspacing="0">
			<tbody>
				<?php $loop = 0; foreach ( $attributes as $name => $options ) : $loop++; ?>
					<tr>
						<td style="padding-top:5px; color:#d60158" class="label"><label for="<?php echo sanitize_title( $name ); ?>"><?php echo wc_attribute_label( $name ); ?></label></td>
					</tr>
					<tr>
		...
		<div class="single_variation_wrap" style="display:none;">
			...
			<div class="variations_button">
				<span style="color:#d60158; font-weight:bold">Quantidade</span>
